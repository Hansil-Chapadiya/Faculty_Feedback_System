...
namespace Project_UI
{
    public partial class Send_Notification : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            string conString = connectionString.Replace("Project", Session["team_id"].ToString());
            cn.ConnectionString = conString;
            String get_enroll = "select User_id from Year_" + DropDownList2.SelectedItem.Text + " where Subject_Code = " + DropDownList3.SelectedItem + " AND Sem = '" + DropDownList1.SelectedItem + "'";
