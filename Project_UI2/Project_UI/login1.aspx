                ...
                <div class="col-md-6">
                    <div class="myLeftCtn">
                        <form class="myForm text-center" runat="server">
                            ...
                            <div class="form-group">
                                <cap:CaptchaControl ID="captcha1" runat="server" CaptchaLength="5" CaptchaHeight="50" CaptchaWidth="200" CaptchaLineNoise="Low" CaptchaMinTimeout="3" CaptchaMaxTimeout="240" ForeColor="White" CaptchaChars="ABCDEFGHIJKLMNOPQRSTUVWXYZ12345678990abcdefghijklmnopqrstuvwxyz" Height="47px" Width="200px" CssClass="ml-5" /><br />
