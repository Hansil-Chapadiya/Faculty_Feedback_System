<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Remove_Student.aspx.cs" Inherits="Project_UI.Remove_Student" %>
                    ...
                    <form class="myForm text-center" runat="server">
                        <div class="myLeftCtn">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TextBox5" runat="server" placeholder="ER Number" class="myInput" required="true"></asp:TextBox>
                            </div>
