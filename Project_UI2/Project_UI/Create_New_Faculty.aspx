<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create_New_Faculty.aspx.cs" Inherits="Project_UI.Create_New_Faculty" %>
                    ...
                    <form class="myForm text-center" runat="server">
                        <div class="myLeftCtn">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TextBox2" runat="server" placeholder="Faculty ID" class="myInput" required="true" TextMode="Number"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <i class="fas fa-lock"></i>
                                <asp:TextBox ID="TextBox3" runat="server" placeholder="Password" class="myInput" required="true" TextMode="Password"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <i class="fas fa-lock"></i>
